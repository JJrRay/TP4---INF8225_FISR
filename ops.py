...
def Conv2d(x, shape, name):
    w = tf.compat.v1.get_variable(name + '/w', shape, initializer=tf.keras.initializers.glorot_normal())
    b = tf.compat.v1.get_variable(name + '/b', shape[3], initializer=tf.constant_initializer(0))
