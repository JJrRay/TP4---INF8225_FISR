...
def parse_args():
    ...
    parser.add_argument('--init_lr', type=float, default=0.0001, help='The initial learning rate')
        # Learning rate boundaries and values for piecewise constant decay
    parser.add_argument('--lr_values', type=float, nargs='+', default=[0.0001, 0.00001, 0.000001],
                        help='Learning rate values for piecewise constant schedule')
    parser.add_argument('--lr_boundaries', type=int, nargs='+', default=[20, 40],
                        help='Boundaries (epochs) where the learning rate changes')
